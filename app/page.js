...
import {getReverseFormula, loadData, parseFormula, transform,} from "./components/baseFunction";
    ...
    const referenceColumns = [
        {
            ...
            align: "center",
            render: (value, record) => {
                return <a className={"text-4xl"} href={record.链接} target={"_blank"}>{record.文章}</a>
            },
        },
    ];
